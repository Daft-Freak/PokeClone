...
public class PokemonMove021ScaryFace extends PokemonMove
{
	public PokemonMove021ScaryFace() {
		super(21);
	}
	@Override
	...
	public int performMove(PokemonMonster source, PokemonMonster target,
		...
		target.statMod(6, -2, true, false, battle);
		return 0;
	}
	@Override
	public String info() {
		return "The user frightens the target with a scary face to harshly reduce its Speed stat.";
	}
	@Override
	public PokemonMove copy() {
		return new PokemonMove021ScaryFace();
	}
}